...
<body>
    ...
    <form action="{{ url('admin/logout') }}" id="logout-form" method="POST" style="display: none";>@csrf</form>
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="{{url ('admin/categories')}}">
                                <i class="mdi mdi-hexagon"></i> <span data-key="t-categories">Category</span>
                            </a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link menu-link" href="{{url ('admin/blogposts')}}">
                                <i class="mdi mdi-typewriter"></i> <span data-key="t-blogposts">Blog Posts</span>
                            </a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link menu-link" href="{{url ('admin/breakingnews')}}">
                                <i class="mdi mdi-newspaper-variant-multiple-outline"></i> <span data-key="t-breakingnews">Breaking News</span>
                            </a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link menu-link" href="{{url ('admin/newsletters')}}">
                                <i class="mdi mdi-email-newsletter"></i> <span data-key="t-newsletters">Newsletter</span>
                            </a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link menu-link" href="{{url ('admin/users')}}">
                                <i class="mdi mdi-human-capacity-increase"></i> <span data-key="t-users">Users</span>
                            </a>
                        </li>
    ...
    <script src="{{asset('assets/cloudflare/ajax/libs/pdfmake/0.1.53/vfs_fonts.js')}}"></script>
    <script src="{{asset('assets/cloudflare/ajax/libs/pdfmake/0.1.53/pdfmake.min.js')}}"></script>
    <script src="{{asset('assets/cloudflare/ajax/libs/jszip/3.1.3/jszip.min.js')}}"></script>

    <script src="{{asset('assets/js/pages/datatables.init.js')}}"></script>
    <script src="{{asset('assets/jsdelivr/npm/axios/dist/axios.min.js')}}"></script>
    <script src="{{asset('assets/cloudflare/ajax/libs/moment.js/2.29.1/moment.min.js')}}"></script>
    <script src="{{asset('assets/cloudflare/ajax/libs/pdfmake/0.1.53/pdfmake.min.js')}}"></script>
    <script src="{{asset('assets/cloudflare/ajax/libs/pdfmake/0.1.32/vfs_fonts.js')}}"></script>
